...
namespace Avantik.Web.Service.Extension
{
    public static class RequestValidation
    {
        ...
        public static GetSeatMapResponse Valid(this Avantik.Web.Service.Message.SeatMap.GetSeatMapRequest request, GetSeatMapResponse response, Entity.Authentication objAuthen)
        {
            ...
            else if (string.IsNullOrEmpty(request.FlightId) || new Guid(request.FlightId) == Guid.Empty)
            {
                bError = true;
                strMessage += "Flight Id is required.";
                code = "P023";
            }
            else if (string.IsNullOrEmpty(request.BoardingClass))
            {
                bError = true;
        ...
        public static GetSeatMapRequest SeatMapRequest(this GetSeatMapRequest request)
        {
            ...
            result.Origin = request.Origin.Trim().ToUpper();
            result.Destination = request.Destination.Trim().ToUpper();
        ...
        public static void FillMissingData(this IList<Avantik.Web.Service.Message.ManageBooking.ChangeFlight> f)
        {
