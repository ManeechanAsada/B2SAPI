...
namespace Avantik.Web.Service.Extension
{
    ...
    {
        public static IList<Message.Fee.Fee> ToFeeMessage(this IList<Entity.Fee> objEntitytFeeList,string user,string origin ,string destination)
        {
            ...
            if (objEntitytFeeList != null)
            {
                ...
                {
                    objMessageFeeList.Add(objEntitytFeeList[i].ToFeeMessage(user,origin,destination));
                }
            }
            return objMessageFeeList;
        }

        public static Message.Fee.Fee ToFeeMessage(this Entity.Fee f, string user, string origin, string destination)
        {
            ...
            if(f != null)
            {
               ...
               // fee.NumberOfUnits = f.NumberOfUnits;
                fee.OdDestinationRcd = destination;
                fee.OdFlag = f.OdFlag;
                fee.OdOriginRcd = origin;
                fee.OriginRcd = origin;
